...
while ($row = mysqli_fetch_array($query)) {
    ?>
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <a href="news-details.php?nid=<?php echo htmlentities($row['pid']) ?>"
                            class="btn btn-primary">Дэлгэрэнгүй &rarr;</a>
                    </div>
                    <div class="card-footer text-muted">
                        Нийтлэсэн огноо: <?php echo htmlentities($row['postingdate']); ?>
                ...
                <ul class="pagination justify-content-center mb-4">
                    <li class="page-item"><a href="?pageno=1" class="page-link">Эхнийх</a></li>
                    <li class="<?php if ($pageno <= 1) {echo 'disabled';}?> page-item">
                        <a href="<?php if ($pageno <= 1) {echo '#';} else {echo "?pageno=" . ($pageno - 1);}?>"
                            class="page-link">Өмнөх</a>
                    </li>
                    <li class="<?php if ($pageno >= $total_pages) {echo 'disabled';}?> page-item">
                        <a href="<?php if ($pageno >= $total_pages) {echo '#';} else {echo "?pageno=" . ($pageno + 1);}?> "
                            class="page-link">Дараагийн</a>
                    </li>
                    <li class="page-item"><a href="?pageno=<?php echo $total_pages; ?>" class="page-link">Сүүлийн</a>
                    </li>
                </ul>
