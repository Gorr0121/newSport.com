...
<head>
    ...
    <title>News Portal | Нүүр хуудас</title>
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <p>
                            ...
                            <b>Нийтлэсэн </b> <?php echo htmlentities($row['postedBy']); ?>
                            </b><?php echo htmlentities($row['postingdate']); ?> |
                            <?php if ($row['lastUpdatedBy'] != ''): ?>
                            <b>Сүүлд зассан </b> <?php echo htmlentities($row['lastUpdatedBy']); ?>
                            </b><?php echo htmlentities($row['UpdationDate']); ?>
                        </p>
                        <?php endif;?>
                        <p><strong>Хуваалцах:</strong> <a
                                href="http://www.facebook.com/share.php?u=<?php echo $currenturl; ?>"
                                target="_blank">Facebook</a> |
                            <a href="https://twitter.com/share?url=<?php echo $currenturl; ?>"
                                target="_blank">Twitter</a> |
                            <a href="https://web.whatsapp.com/send?text=<?php echo $currenturl; ?>"
                                target="_blank">Whatsapp</a> |
                            <a href="http://www.linkedin.com/shareArticle?mini=true&amp;url=<?php echo $currenturl; ?>"
                                target="_blank">Linkedin</a> <b>Зочилсон:</b> <?php print $visits;?>
                        </p>
                        <hr />
...
$pt = $row['postdetails'];
    echo (substr($pt, 0));?></p>
        ...
        <div class="row" style="margin-top: -8%">
            <div class="col-md-8">
                <div class="card my-4">
                    <h5 class="card-header">Сэтгэгдэл үлдээх:</h5>
                    <div class="card-body">
                        <form name="Comment" method="post">
                            <input type="hidden" name="csrftoken"
                                value="<?php echo htmlentities($_SESSION['token']); ?>" />
                            <div class="form-group">
                                <input type="text" name="name" class="form-control" placeholder="Бүтэн нэрээ оруулна уу"
                                    required>
                            </div>
                            ...
                            <div class="form-group">
                                <textarea class="form-control" name="comment" rows="3" placeholder="Сэтгэгдэл"
                                    required></textarea>
                            </div>
                            <button type="submit" class="btn btn-primary" name="submit">Илгээх</button>
                        </form>
                    </div>
                </div>
